...
syntax clear
so $HOME/.vim/syntax/mediawiki.vim

"Mappings {{{1
"
"This should allow you to press "WH1" in INSERT mode, then
...
imap <buffer> WH1 ====== <++> ======<CR><++><Esc>k0<C-J>
imap <buffer> WH2 ===== <++> =====<CR><++><Esc>k0<C-J>
imap <buffer> WH3 ==== <++> ====<CR><++><Esc>k0<C-J>
imap <buffer> WH4 === <++> ===<CR><++><Esc>k0<C-J>
imap <buffer> WH5 == <++> ==<CR><++><Esc>k0<C-J>
imap <buffer> WH6 = <++> =<CR><++><Esc>k0<C-J>
